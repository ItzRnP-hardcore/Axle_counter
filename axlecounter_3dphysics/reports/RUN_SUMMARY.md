...
- Fresh: `coil_parameter_sweep_femm.csv`, `frequency_sweep_femm.csv`,
  ...
  `optimal_design.json`, figures **01–09 and 11**, refreshed notebooks,
  `sanity_check_report.md`.
- **Not regenerated:** `figures/10_femm_doe_sweep.png`,
  `figures/12_detection_dip.png`, `figures/13_design_table.png`. No script in
  the repo writes these three (grep finds no generator); they date from
  2026-07-15 and are carried forward as historical images. Earlier revisions of
  this summary claimed "all 13 figures" were fresh — only 10 of them are.
