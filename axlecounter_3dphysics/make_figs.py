...
sub2=csv[(csv.Frequency_Hz==20000)&(csv.Primary_Turns_Np==150)&(csv.Wire_Gauge_AWG==24)].sort_values("Flux_Loss_Pct")
fig,ax=plt.subplots(figsize=(7.8,5.4))
...
ax.set_title("Capacitor Voltage Feasibility vs Flux Loss (20 kHz, Np=150)"); ax.legend()
...
subg=csv[(csv.Frequency_Hz==20000)&(csv.Primary_Turns_Np==150)&(csv.Flux_Loss_Pct==flt)].sort_values("Wire_Gauge_AWG")
fig,ax=plt.subplots(figsize=(7.8,5.4))
...
ax.set_title(f"Effect of Wire Gauge (20 kHz, Np=150, flux loss {flt:g}%)")
